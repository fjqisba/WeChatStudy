namespace micromsg
{
    ...
    public sealed class InviteChatRoomMemberRequest : GeneratedMessageLite<InviteChatRoomMemberRequest, InviteChatRoomMemberRequest.Builder>
    {
        private static readonly string[] _inviteChatRoomMemberRequestFieldNames = new string[] { "BaseRequest", "ChatRoomName", "MemberCount", "MemberList" };
        private static readonly uint[] _inviteChatRoomMemberRequestFieldTags = new uint[] { 10, 0x22, 0x10, 0x1a };
        ...
        private static readonly InviteChatRoomMemberRequest defaultInstance = new InviteChatRoomMemberRequest().MakeReadOnly();
        ...
        static InviteChatRoomMemberRequest()
        {
            
        }

        private InviteChatRoomMemberRequest()
        {
        }
        ...
        public static Builder CreateBuilder(InviteChatRoomMemberRequest prototype)
        {
        ...
        {
            InviteChatRoomMemberRequest request = obj as InviteChatRoomMemberRequest;
            if (request == null)
            {
                return false;
            }
        ...
        private InviteChatRoomMemberRequest MakeReadOnly()
        {
            this.memberList_.MakeReadOnly();
            return this;
        }

        public static InviteChatRoomMemberRequest ParseFrom(byte[] data)
        {
        ...
        {
            GeneratedMessageLite<InviteChatRoomMemberRequest, Builder>.PrintField("BaseRequest", this.hasBaseRequest, this.baseRequest_, writer);
            GeneratedMessageLite<InviteChatRoomMemberRequest, Builder>.PrintField("MemberCount", this.hasMemberCount, this.memberCount_, writer);
            GeneratedMessageLite<InviteChatRoomMemberRequest, Builder>.PrintField<MemberReq>("MemberList", this.memberList_, writer);
            GeneratedMessageLite<InviteChatRoomMemberRequest, Builder>.PrintField("ChatRoomName", this.hasChatRoomName, this.chatRoomName_, writer);
        }
        ...
        public override void WriteTo(ICodedOutputStream output)
        {
            ...
            string[] strArray = _inviteChatRoomMemberRequestFieldNames;
            if (this.hasBaseRequest)
            {
        ...
        public static InviteChatRoomMemberRequest DefaultInstance
        {
            get
            {
        ...
        public override InviteChatRoomMemberRequest DefaultInstanceForType
        {
            get
            {
                return DefaultInstance;
        ...
        protected override InviteChatRoomMemberRequest ThisMessage
        {
            get
            {
                return this;
        ...
        public sealed class Builder : GeneratedBuilderLite<InviteChatRoomMemberRequest, InviteChatRoomMemberRequest.Builder>
        {
            private InviteChatRoomMemberRequest result;
            private bool resultIsReadOnly;

            public Builder()
            {
                this.result = InviteChatRoomMemberRequest.DefaultInstance;
                this.resultIsReadOnly = true;
            }

            internal Builder(InviteChatRoomMemberRequest cloneFrom)
            {
                this.result = cloneFrom;
                this.resultIsReadOnly = true;
            }

            public InviteChatRoomMemberRequest.Builder AddMemberList(MemberReq value)
            {
            ...
            public InviteChatRoomMemberRequest.Builder AddMemberList(MemberReq.Builder builderForValue)
            {
            ...
            public InviteChatRoomMemberRequest.Builder AddRangeMemberList(IEnumerable<MemberReq> values)
            {
                this.PrepareBuilder();
            ...
            public override InviteChatRoomMemberRequest BuildPartial()
            {
            ...
            public override InviteChatRoomMemberRequest.Builder Clear()
            {
                this.result = InviteChatRoomMemberRequest.DefaultInstance;
                this.resultIsReadOnly = true;
                return this;
            ...
            public InviteChatRoomMemberRequest.Builder ClearBaseRequest()
            {
                this.PrepareBuilder();
            ...
            public InviteChatRoomMemberRequest.Builder ClearChatRoomName()
            {
                this.PrepareBuilder();
            ...
            public InviteChatRoomMemberRequest.Builder ClearMemberCount()
            {
                this.PrepareBuilder();
            ...
            public InviteChatRoomMemberRequest.Builder ClearMemberList()
            {
                this.PrepareBuilder();
            ...
            public override InviteChatRoomMemberRequest.Builder Clone()
            {
                if (this.resultIsReadOnly)
                {
                    return new InviteChatRoomMemberRequest.Builder(this.result);
                }
                return new InviteChatRoomMemberRequest.Builder().MergeFrom(this.result);
            }
            ...
            public InviteChatRoomMemberRequest.Builder MergeBaseRequest(BaseRequest value)
            {
                ThrowHelper.ThrowIfNull(value, "value");
                this.PrepareBuilder();
            ...
            public InviteChatRoomMemberRequest.Builder MergeChatRoomName(SKBuiltinString_t value)
            {
                ThrowHelper.ThrowIfNull(value, "value");
                this.PrepareBuilder();
            ...
            public override InviteChatRoomMemberRequest.Builder MergeFrom(ICodedInputStream input)
            {
                return this.MergeFrom(input, ExtensionRegistry.Empty);
            }

            public override InviteChatRoomMemberRequest.Builder MergeFrom(IMessageLite other)
            {
                if (other is InviteChatRoomMemberRequest)
                {
                    return this.MergeFrom((InviteChatRoomMemberRequest) other);
                }
                base.MergeFrom(other);
                return this;
            }

            public override InviteChatRoomMemberRequest.Builder MergeFrom(InviteChatRoomMemberRequest other)
            {
                return this;
            }
            ...
            private InviteChatRoomMemberRequest PrepareBuilder()
            {
                if (this.resultIsReadOnly)
                {
                    InviteChatRoomMemberRequest result = this.result;
                    this.result = new InviteChatRoomMemberRequest();
            ...
            public InviteChatRoomMemberRequest.Builder SetBaseRequest(micromsg.BaseRequest value)
            {
                ThrowHelper.ThrowIfNull(value, "value");
                this.PrepareBuilder();
                this.result.hasBaseRequest = true;
            ...
            public InviteChatRoomMemberRequest.Builder SetBaseRequest(micromsg.BaseRequest.Builder builderForValue)
            {
                ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
                this.PrepareBuilder();
                this.result.hasBaseRequest = true;
            ...
            public InviteChatRoomMemberRequest.Builder SetChatRoomName(SKBuiltinString_t value)
            {
                ThrowHelper.ThrowIfNull(value, "value");
                this.PrepareBuilder();
                this.result.hasChatRoomName = true;
            ...
            public InviteChatRoomMemberRequest.Builder SetChatRoomName(SKBuiltinString_t.Builder builderForValue)
            {
                ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
                this.PrepareBuilder();
                this.result.hasChatRoomName = true;
            ...
            public InviteChatRoomMemberRequest.Builder SetMemberCount(uint value)
            {
                this.PrepareBuilder();
            ...
            public InviteChatRoomMemberRequest.Builder SetMemberList(int index, MemberReq value)
            {
                ThrowHelper.ThrowIfNull(value, "value");
                this.PrepareBuilder();
            ...
            public InviteChatRoomMemberRequest.Builder SetMemberList(int index, MemberReq.Builder builderForValue)
            {
                ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
                this.PrepareBuilder();
            ...
            public override InviteChatRoomMemberRequest DefaultInstanceForType
            {
                get
                {
                    return InviteChatRoomMemberRequest.DefaultInstance;
                }
            }
            ...
            protected override InviteChatRoomMemberRequest MessageBeingBuilt
            {
                get
                {
            ...
            protected override InviteChatRoomMemberRequest.Builder ThisBuilder
            {
                get
                {
                    return this;
